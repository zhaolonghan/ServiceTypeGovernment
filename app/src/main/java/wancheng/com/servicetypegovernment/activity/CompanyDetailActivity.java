                            ...
                            if("0".equals(code)){
                                ...
                                if(data!=null&&data!=""){
                                   /* JSONArray dataArray=new JSONArray(data);
                                    ...
                                    mapinfo.put("permit_name", JSONUtils.getString(permitobject, "name", ""));
                                    mapinfo.put("permit_code", JSONUtils.getString(permitobject, "code", ""));
                                    mapinfo.put("permit_beginDate", JSONUtils.getString(permitobject, "beginDate", ""));
                                    mapinfo.put("permit_endTime", JSONUtils.getString(permitobject, "endTime", ""));
                                    mapinfo.put("permit_sendOrg", JSONUtils.getString(permitobject, "sendOrg", ""));
                                    mapinfo.put("permit_scope", JSONUtils.getString(permitobject, "scope", ""));
                                    ...
                                    mapinfo.put("businessLicense_name", JSONUtils.getString(businessLicenseobject, "name", ""));
                                    mapinfo.put("businessLicense_code", JSONUtils.getString(businessLicenseobject, "code", ""));
                                    mapinfo.put("businessLicense_sendTime", JSONUtils.getString(businessLicenseobject, "sendTime", ""));
                                    mapinfo.put("businessLicense_scope", JSONUtils.getString(businessLicenseobject, "scope", ""));
                                    mapinfo.put("businessLicense_sendOrg", JSONUtils.getString(businessLicenseobject, "sendOrg", ""));
                                    mapinfo.put("businessLicense_beginDate", JSONUtils.getString(businessLicenseobject, "beginDate", ""));
                                    mapinfo.put("businessLicense_endTime", JSONUtils.getString(businessLicenseobject, "endTime", ""));
