package wancheng.com.servicetypegovernment.route;
 ...
 * 导航路线图层类。
 */
public class WalkRouteOverLays extends RouteOverlayWalk{
     ...
     */
    public WalkRouteOverLays(Context context, AMap amap, WalkPath path,
                             LatLonPoint start, LatLonPoint end, List<LatLonPoint> throughPointList,Marker startMarker,Marker endMarker) {
    	super(context);
    	mContext = context;
        mAMap = amap;
        this.walkPath = path;
